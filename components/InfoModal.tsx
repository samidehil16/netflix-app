...
const InfoModal: React.FC<InfoModalProps> = ({visible,onClose}) =>{
    ...
    return (
        <div className="z-50 transition duration-200 bg-black bg-opacity-80 flex justify-center items-center
        overflow-x-hidden overflow-y-auto fixed inset-0">
           <div className="relative w-auto mx-auto max-w-3xl rounded-md overflow-hidden">
                <div className={`${isVisible ? 'scale-100' : 'scale-0' } transform duration-200
                relative flex-auto bg-zinc-900 drop-shadow-md`}>
                    <div className="relative h-96">
                        ...
                        <div onClick={handleClose} className="cursor-pointer absolute top-3 right-3 h-10 w-10
